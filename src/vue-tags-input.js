...
export default {
  ...
  methods: {
    onClickOutsideVueTagInput (event) {
      if (this.cancelEditOnBlurWrapper) {
        for (let index = 0; index <= this.tagsEditStatus.length; index++) {
          let statusEdit = this.tagsEditStatus[index];
          if (statusEdit) {
